...
from common.system_model import CreateTableSet, FieldSet
...
from common.system_model import db_session
...
class MakeModel:
    ...
    def makeBaseModel(self):
        notes = 'from common.system_model import db_session, engine, Base'
